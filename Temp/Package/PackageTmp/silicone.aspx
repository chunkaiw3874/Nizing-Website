<%@ Page Title="" Language="C#" MasterPageFile="~/master/RWDMaterialMaster.master" AutoEventWireup="true" CodeFile="silicone.aspx.cs" Inherits="silicone" %>

<asp:Content ID="head" ContentPlaceHolderID="head" runat="Server">
    <title>日進電線-矽膠特性</title>
    <meta name="keywords" content="電線,外被,矽膠,Wire,Insulation Material,Silicone" />
</asp:Content>
