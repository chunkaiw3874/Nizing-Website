        ...
        <div id="SearchCondition" class="form-group">
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NEOConnectionString %>" SelectCommand="SELECT DISTINCT TG006, TG006+' '+MV002 MV002
                    FROM COPTG
