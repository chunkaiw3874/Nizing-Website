<%@ Page Title="" Language="C#" MasterPageFile="~/master/RWDProductMaster.master" AutoEventWireup="true" CodeFile="heating-wire.aspx.cs" Inherits="heating_wire" %>
    ...
    <div class="container-fluid">
        <div class="banner">
            <img src="/images/banner/banner-product-en.png"
                alt="發熱線 Heating Wire 醫療用呼吸加熱管發熱線 Medical Respiration Pipe Heating Wire 並聯式發熱帶 PHC Parallel Heating Cable UL3323 UL3589" />
        </div>
    </div>
</asp:Content>
