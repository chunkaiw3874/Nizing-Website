...
public partial class silicone_fiberglass_wire : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("/zh/product/silicone-fiberglass-wire");
        }
        ...
        if (!IsPostBack)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                PopulateProductListItem(dt, language);
            }
        }
    }
    ...
    protected void PopulateProductListItem(DataTable dt, string language)
    {
        foreach (DataRow dr in dt.Rows)
        {
            ...
            if (dr["HotItem"] == DBNull.Value ? false : (bool)dr["HotItem"])
            {
                ...
                img.Src = "/images/product/hot-icon.png";
