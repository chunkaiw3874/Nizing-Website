<%@ Page Title="" Language="C#" MasterPageFile="~/en/master/product-detail.master" AutoEventWireup="true" CodeFile="vde-h05ss-f.aspx.cs" Inherits="vde_h05ss_f" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/en/images/product_pic/vde_h05ss-f-1.jpg" AlternateText="VDE H05SS-F Silicone Multi-Core Wire" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/en/images/product_pic/vde_h05ss-f-2.jpg" AlternateText="VDE H05SS-F Silicone Multi-Core Wire" />
    </div>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>VDE H05SS-FSilicone Multi-Core Wire is suitable for fields that require high temperature endurance. Application ranges from household appliances, lighting devices, to industrial machines, and high-temperature furnaces. Passed UL VW-1 Vertical fire test and multiple IEC tests, proven to be low smoke density, halogen free, and flame retardant.</td>
        </tr>
    </table>
    <div class="subtitle">
        Technical Data
