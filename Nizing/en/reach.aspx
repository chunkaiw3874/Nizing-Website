<%@ Page Title="" Language="C#" MasterPageFile="~/en/master/child.master" AutoEventWireup="true" CodeFile="reach.aspx.cs" Inherits="reach" %>
    ...
    <div id="certificate-document">
        <div class="inner-content">
            <div class="content-row">
                <div class="icon">
                    <asp:HyperLink ID="HyperLink3" runat="server" ImageUrl="~/en/images/certificate/cert_reach1-small.jpg" NavigateUrl="~/en/images/certificate/cert_reach1.jpg" Target="_blank"></asp:HyperLink>
                </div>
            </div>
        </div>
    </div>
