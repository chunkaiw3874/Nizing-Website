<%@ Page Title="" Language="C#" MasterPageFile="~/en/master/product-detail.master" AutoEventWireup="true" CodeFile="ul3074.aspx.cs" Inherits="ul3074" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/en/images/product_pic/ul3074-1.jpg" AlternateText="UL3074 Silicone Fiberglass Wire" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/en/images/product_pic/ul3074-2.jpg" AlternateText="UL3074 Silicone Fiberglass Wire" />
    </div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
    <asp:Image ID="Image4" runat="server" ImageUrl="~/en/images/product_pic/professional_3.jpg" AlternateText="UL3074 Silicone Fiberglass Wire" />
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>UL3074 is suitable for fields that require high temperature endurance. Application ranges from household appliances, lighting devices, to industrial machines, and high-temperature furnaces. Passed UL VW-1 Vertical fire test and multiple IEC tests, proven to be low smoke density, halogen free, and flame retardant.</td>
        </tr>
    </table>
    <div class="subtitle">
        Technical Data
...
<asp:Content ID="Content10" ContentPlaceHolderID="detailDescription" Runat="Server">
    <div class="subtitle">
        UL3074 Silicone Fiberglass Wire Spec
    </div>
    <div class="content">
        <table>
          <tr>
