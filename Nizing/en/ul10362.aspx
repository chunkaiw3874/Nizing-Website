<%@ Page Title="" Language="C#" MasterPageFile="~/en/master/product-detail.master" AutoEventWireup="true" CodeFile="ul10362.aspx.cs" Inherits="ul10362" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/en/images/product_pic/ul10362-1.jpg" AlternateText="UL10362 PFA Teflon Wire" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/en/images/product_pic/ul10362-2.jpg" AlternateText="UL10362 PFA Teflon Wire" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
    <asp:Image ID="Image3" runat="server" ImageUrl="~/en/images/product_pic/ul10362-3.jpg" AlternateText="UL10362 PFA Teflon Wire" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
    <asp:Image ID="Image4" runat="server" ImageUrl="~/en/images/product_pic/professional_3_2.jpg" AlternateText="UL10362 PFA Teflon Wire" />
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="largePicArea3" Runat="Server">
    <%--<asp:Image ID="Image5" runat="server" ImageUrl="~/en/images/product_pic/lshf.jpg" AlternateText="UL10362 PFA Teflon Wire" />--%>
</asp:Content>
...
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" runat="server">
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/en/pdf/ul10362.pdf" ImageUrl="~/en/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>
</asp:Content>
