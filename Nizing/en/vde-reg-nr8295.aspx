<%@ Page Title="" Language="C#" MasterPageFile="~/en/master/product-detail.master" AutoEventWireup="true" CodeFile="vde-reg-nr8295.aspx.cs" Inherits="vde_reg_nr8295" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/en/images/product_pic/vde_reg-nr8295-1.jpg" AlternateText="VDE REG-NR8295 Duo-Layer FEP Teflon Wire" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/en/images/product_pic/vde_reg-nr8295-2.jpg" AlternateText="VDE REG-NR8295 Duo-Layer FEP Teflon Wire" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
        <asp:Image ID="Image3" runat="server" ImageUrl="~/en/images/product_pic/vde_reg-nr8295-3.jpg" AlternateText="VDE REG-NR8295 Duo-Layer FEP Teflon Wire" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
        <asp:Image ID="Image4" runat="server" ImageUrl="~/en/images/product_pic/professional_2_6.jpg" AlternateText="VDE REG-NR8295 Duo-Layer FEP Teflon Wire" />
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="largePicArea3" Runat="Server">
        <asp:Image ID="Image5" runat="server" ImageUrl="~/en/images/product_pic/lshf.jpg" AlternateText="VDE REG-NR8295 Duo-Layer FEP Teflon Wire" />
</asp:Content>
<asp:Content ID="Content7" ContentPlaceHolderID="prdTitle" runat="server">
    Duo-Layer FEP Teflon Wire<br />
    VDE REG-NR8295
</asp:Content>
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" runat="server">
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/en/pdf/vde_reg_nr8295.pdf" ImageUrl="~/en/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>
</asp:Content>
...
<asp:Content ID="Content10" ContentPlaceHolderID="detailDescription" Runat="Server">
    <div class="subtitle">
        VDE REG-NR8295 Duo-Layer FEP Teflon Wire Spec
    </div>
    <div class="content">
        <table>
          <tr>
