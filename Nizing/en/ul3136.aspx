<%@ Page Title="" Language="C#" MasterPageFile="~/en/master/product-detail.master" AutoEventWireup="true" CodeFile="ul3136.aspx.cs" Inherits="ul3136" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/en/images/product_pic/ul3136-1.jpg" AlternateText="UL3136 Silicone Wire" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/en/images/product_pic/ul3136-2.jpg" AlternateText="UL3136 Silicone Wire" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
        <asp:Image ID="Image3" runat="server" ImageUrl="~/en/images/product_pic/ul3136-3.jpg" AlternateText="UL3136 Silicone Wire" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
        <asp:Image ID="Image4" runat="server" ImageUrl="~/en/images/product_pic/professional_3.jpg" AlternateText="UL3136 Silicone Wire" />
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="largePicArea3" Runat="Server">
        <%--<asp:Image ID="Image5" runat="server" ImageUrl="~/en/images/product_pic/lshf.jpg" AlternateText="UL3136 Silicone Wire" />--%>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>UL3136 Silicone Wire is suitable for fields that require high temperature endurance. Application ranges from household appliances, lighting devices, to industrial machines, and high-temperature furnaces. Passed UL VW-1 Vertical fire test and multiple IEC tests, proven to be low smoke density, halogen free, and flame retardant.</td>
        </tr>
    </table>
    <div class="subtitle">
        Technical Data
