...
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
        <asp:Image ID="Image4" runat="server" ImageUrl="~/en/images/product_pic/certificate-2.svg" AlternateText="UL3136 Silicone Wire" />
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>UL3136 Silicone Wire is suitable for fields that require high temperature endurance. Application ranges from household appliances, lighting devices, to industrial machines, and high-temperature furnaces.</td>
        </tr>
    </table>
    <div class="subtitle">
        Technical Data
