<%@ Page Title="" Language="C#" MasterPageFile="~/master/productMaster2021.master" AutoEventWireup="true" CodeFile="rsge.aspx.cs" Inherits="ul1007" %>
            ...
            <div class="container">
                ...
                <div class="block content product">
                    <div class="content row">
                        <div class="col-7 pl-0">
                            <div class="product-image">
                                <img src="images/product_pic/silicone-fiberglass-wire/rsge-yellowgreen-1000x450.jpg" class="img w-100" />
                            </div>
                            <div class="color-code-section d-flex align-items-center justify-content-end">
                                <div>
                                    Color:
                                </div>
                        ...
                        <div class="col-5 pr-0 d-flex flex-column justify-content-between product-text">
                            <div>
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <img src="images/certificate/iso9001/ISO9001-2015.jpg" class="img w-100" />
                                </div>

                                <div class="col-2">
                                    <img src="images/certificate/rohs/rohs.png" class="img w-100" />
                                </div>
                                <div class="col-2">
                                    <img src="images/certificate/reach/REACH.jpg" class="img w-100" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="content row product-spec">
                    ...
                    <br />
                                ...
                                <tr>
                                    <td colspan="10" class="text-center">最大平方數: 250mm² 耐熱電纜線</td>
                                </tr>
                            </table>
                        </div>
                    </div>
