<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="e-type.aspx.cs" Inherits="e_type" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" runat="Server">
    <title>補償導線E-Type-日進電線</title>
    <meta name="description" content="補償導線E-Type為工業用熱電偶中，熱電動勢值最高的一種。大型火力及核能發電廠均採用。正極之鎳、 鉻合金與K-Type同有Green-Rot 之現象，使用時宜採取相似之措施。其電阻較大，應慎選機器使用。詳細的補償導線E-Type的產品規格以及使用範圍值。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/etype-1.jpg" AlternateText="E-Type 補償導線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/etype-2.jpg" AlternateText="E-Type 補償導線" />
    </div>
</asp:Content>
...
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" runat="Server">
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/pdf/e-type.pdf" ImageUrl="~/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" runat="Server">
    ...
    <table>
        <tr>
            <td>補償導線E-Type為工業用熱電偶中，熱電動勢值最高的一種。近期需求急速增加，大型火力及核能發電廠均採用。正極之鎳、 鉻合金與K-Type同有Green-Rot 之現象，使用時宜採取相似之措施。其電阻較大，應慎選機器使用。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。</td>
        </tr>
    </table>
</asp:Content>
