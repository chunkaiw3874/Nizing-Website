<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="j-type.aspx.cs" Inherits="j_type" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" Runat="Server">
    <title>補償導線J-Type-日進電線</title>
    <meta name="description" content="補償導線J-Type適合於-210°C~+350°C溫域中使用，熱電動勢特性僅次於E-Type。缺點則是在於因使用純鐵導體的緣故，在含有水分的氧化氣體中容易導致導體生鏽，於使用時須特別注意。詳細的補償導線J-Type的產品規格以及使用範圍值。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/jtype-1.jpg" AlternateText="J-Type 補償導線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/jtype-2.jpg" AlternateText="J-Type 補償導線" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/product_pic/jtype-3.jpg" AlternateText="J-Type 補償導線" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
    <%--<asp:Image ID="Image4" runat="server" ImageUrl="~/images/product_pic/lshf.jpg" AlternateText="J-Type 補償導線" />--%>
</asp:Content>
...
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" Runat="Server">
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/pdf/j-type.pdf" ImageUrl="~/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>J-Type適合於-210°C~+350°C溫域中使用，熱電動勢特性僅次於E-Type。缺點則是在於因使用純鐵導體的緣故，在含有水分的氧化氣體中容易導致導體生鏽，於使用時須特別注意。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。<br />
          註: JIS與DIN合金之熱電動勢不同，故不能相互替用</td>
        </tr>
    </table>
</asp:Content>
