<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="rsge.aspx.cs" Inherits="ul1007" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/rsge-1.jpg" AlternateText="RS-GE 矽膠編織耐熱線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/rsge-2.jpg" AlternateText="RS-GE 矽膠編織耐熱線" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/product_pic/rsge-3.jpg" AlternateText="RS-GE 矽膠編織耐熱線" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/product_pic/certificate-19.svg" AlternateText="RS-GE 矽膠編織耐熱線" />
</asp:Content>
...
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" runat="server">
    <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/pdf/rsge.pdf" ImageUrl="~/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>--%>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>RS-GE電線適用於各種家用電器、照明燈具、工業機器、電熱製品、原料熔爐等高溫場所之配線。</td>
        </tr>
    </table>
    <div class="subtitle">
        技術資料
...
<asp:Content ID="Content10" ContentPlaceHolderID="detailDescription" Runat="Server">
    ...
    <div class="content">
        <table>
          ...
          <tr>
            <td colspan="10">最大平方數: 250mm² 耐熱電纜線</td>            
          </tr>
        </table>
    </div>
</asp:Content>
