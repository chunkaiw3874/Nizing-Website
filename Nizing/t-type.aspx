<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="t-type.aspx.cs" Inherits="t_type" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" runat="Server">
    <title>補償導線T-Type-日進電線</title>
    <meta name="description" content="補償導線T-Type適用於溫域-200°C~+300°C之還原氣體中及弱氧化氣體。因T-Type熱電動勢安定、精度高、使用簡便，故常為實驗室等場所所採用。歐美國家常於低溫域中使用T-Type取代J-Type使用。詳細的補償導線T-Type的產品規格以及使用範圍值。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/ttype-1.jpg" AlternateText="T-Type 補償導線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/ttype-2.jpg" AlternateText="T-Type 補償導線" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" runat="Server">
    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/product_pic/ttype-3.jpg" AlternateText="T-Type 補償導線" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" runat="Server">
    <%--<asp:Image ID="Image4" runat="server" ImageUrl="~/images/product_pic/lshf.jpg" AlternateText="T-Type 補償導線" />--%>
</asp:Content>
...
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" runat="Server">
    <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/pdf/t-type.pdf" ImageUrl="~/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>--%>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" runat="Server">
    ...
    <table>
        <tr>
            <td>補償導線T-Type適用於溫域-200°C~+300°C之還原氣體中及弱氧化氣體。因T-Type熱電動勢安定、精度高、使用簡便，故常為實驗室等場所所採用。歐美國家常於低溫域中使用T-Type取代J-Type使用。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。</td>
        </tr>
    </table>
</asp:Content>
