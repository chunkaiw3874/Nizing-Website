<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="k-type.aspx.cs" Inherits="k_type" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" Runat="Server">
    <title>補償導線K-Type-日進電線</title>
    <meta name="description" content="K-Type補償導線可使用至1200°C左右之高溫，熱電動勢的直線性良好，耐熱，耐蝕性高，在二氧化碳等氣體中，熱電動勢頗為安定。在H2、CO等氣體中，氧氣分壓低的情況下，鎳鉻合金線會劣化而產生'Green Rot'(構成合金的鉻之選擇性氧化現象，因而熱電動勢值會顯著降低而產生誤差)。詳細的補償導線K-Type的產品規格以及使用範圍值。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/ktype-1.jpg" AlternateText="K-Type 補償導線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/ktype-2.jpg" AlternateText="K-Type 補償導線" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/product_pic/ktype-3.jpg" AlternateText="K-Type 補償導線" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
    <%--<asp:Image ID="Image4" runat="server" ImageUrl="~/images/product_pic/lshf.jpg" AlternateText="K-Type 補償導線" />--%>
</asp:Content>
...
<asp:Content ID="Content8" ContentPlaceHolderID="titleRowLink" Runat="Server">
    <%--<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/pdf/k-type.pdf" ImageUrl="~/images/button/download_pdf_button2.jpg" Target="_blank"></asp:HyperLink>--%>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>K-Type補償導線可使用至1200°C左右之高溫，熱電動勢的直線性良好，耐熱，耐蝕性高，在二氧化碳等氣體中，熱電動勢頗為安定。在H2、CO等氣體中，氧氣分壓低的情況下，鎳鉻合金線會劣化而產生"Green Rot"(構成合金的鉻之選擇性氧化現象，因而熱電動勢值會顯著降低而產生誤差)。鐵氟龍、矽膠及玻璃纖維材質通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。</td>
        </tr>
    </table>
</asp:Content>
