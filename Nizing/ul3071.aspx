<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="ul3071.aspx.cs" Inherits="ul3071" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/ul3071-1.jpg" AlternateText="UL3071 矽膠編織耐熱線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/ul3071-2.jpg" AlternateText="UL3071 矽膠編織耐熱線" />
    </div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/product_pic/professional_3.jpg" AlternateText="UL3071 矽膠編織耐熱線" />
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>UL3071電線適用於各種家用電器、照明燈具、工業機器、電熱製品、原料熔爐等高溫場所之配線。通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。</td>
        </tr>
    </table>
    <div class="subtitle">
        技術資料
