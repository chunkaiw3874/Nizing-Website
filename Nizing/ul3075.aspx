...
<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" Runat="Server">
    <title>UL3075矽膠編織耐熱線-日進電線</title>
    <meta name="description" content="UL3075矽膠編織耐熱線，適用於各種家用電器、照明燈具、工業機器、電熱製品、原料熔爐等高溫場所之配線。通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。詳細的產品資訊，包括UL3075矽膠編織耐熱線的產品規格以及使用範圍值">	
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/ul3075-1.jpg" AlternateText="UL3075 矽膠編織耐熱線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/ul3075-2.jpg" AlternateText="UL3075 矽膠編織耐熱線" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/product_pic/ul3075-3.jpg" AlternateText="UL3075 矽膠編織耐熱線" />
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="largePicArea2" Runat="Server">
        <asp:Image ID="Image4" runat="server" ImageUrl="~/images/product_pic/professional_3.jpg" AlternateText="UL3075 矽膠編織耐熱線" />
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="largePicArea3" Runat="Server">
        <%--<asp:Image ID="Image5" runat="server" ImageUrl="~/images/product_pic/lshf.jpg" AlternateText="UL3075 矽膠編織耐熱線" />--%>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>UL3075電線適用於各種家用電器、照明燈具、工業機器、電熱製品、原料熔爐等高溫場所之配線。通過UL VW-1垂直燃燒測試以及多項IEC測試，證實為低煙、無鹵、耐燃之產品。</td>
        </tr>
    </table>
    <div class="subtitle">
        技術資料
