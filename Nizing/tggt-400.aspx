<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="tggt-400.aspx.cs" Inherits="tggt_400" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" Runat="Server">
    <title>TGGT-400 400°C高溫線-日進電線</title>
    <meta name="description" content="TGGT-400 400°C高溫線，適用於各種家用電器、照明燈具、工業機器、電熱製品、原料熔爐等高溫場所之配線。詳細的TGGT-400 400°C高溫線的產品規格以及使用範圍值">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/tggt400-1.jpg" AlternateText="TGGT-400 400°C高溫線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/tggt400-2.jpg" AlternateText="TGGT-400 400°C高溫線" />
    </div>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>TGGT400 400°C高溫線適用於各種家用電器、照明燈具、工業機器、電熱製品、原料熔爐等高溫場所之配線</td>
        </tr>
    </table>
    <div class="subtitle">
        技術資料
