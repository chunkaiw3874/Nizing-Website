...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5>
                    <asp:Label ID="lblName" runat="server" Text="Label"></asp:Label><asp:HyperLink ID="hlSalaryNotification" runat="server" NavigateUrl="~/hr360/user_report/salary_change_notification.aspx">，您有調薪通知!</asp:HyperLink>
                </h5>

            </div>
        </div>
        <div id="day_off_window" runat="server">
