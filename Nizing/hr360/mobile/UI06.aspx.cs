...
public partial class hr360_UI06 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlMonth.SelectedValue = (Convert.ToInt16(DateTime.Today.Month) - 2).ToString("D2");

            if (Session["company"].ToString() == "NIZING")
            {
                ViewState["connectionString"] = NZconnectionString;
                imgCompanyLogo.ImageUrl = "~/hr360/image/image/nizing_logo_945x197.png";
            }
            else
            {
            ...
            if (checkSlipAvailability())
            {
                ...
                using (SqlConnection conn = new SqlConnection(ViewState["connectionString"].ToString()))
                {
                    ...
                    SqlCommand cmdSelect = new SqlCommand(
                        "SELECT PALTI.TI002 發薪年月" +
                        " ,CMSMJ.MJ003 職稱" +
                        " ,CMSME.ME001 部門代號" +
                        " ,CMSME.ME002 部門名稱" +
                        " ,PALTI.TI001 員工代號" +
                        " ,CMSMV.MV002 員工名稱" +
                        " ,(PALTI.TI023+PALTI.TI024) N'底(本)薪'" +
                        " ,(PALTI.TI029+PALTI.TI030) N'全勤獎金'" +
                        " ,(PALTI.TI025+PALTI.TI026+PALTI.TI027+PALTI.TI028) N'加班費'" +
                        " ,(PALTI.TI031+PALTI.TI032) N'請假扣款'" +
                        " ,PALTI.TI033 N'健保費'" +
                        " ,PALTI.TI034 N'勞保費'" +
                        " ,PALTI.TI053 N'員工提撥'" +
                        " ,(PALTI.TI079+PALTI.TI080) N'補充保費'" +
                        ...
                        " ,PALTI.TI054 N'公司提繳'" +
                        " ,PALTI.TI055 N'員工提繳'" +
                        " ,PALTI.TI056 N'公司累計提繳'" +
                        " ,(PALTI.TI042+PALTI.TI043) N'課稅所得'" +
                        " ,(PALTI.TI040+PALTI.TI041) N'實發金額'" +
                        " ,CMSMV.MV036 N'薪轉帳號'" +
                        " ,PALTI.TI016 '出勤天數'" +
                        " FROM PALTI"
                    ...
                    + " ,(PALTI.TI042+PALTI.TI043),(PALTI.TI040+PALTI.TI041),CMSMV.MV036" +
                    " ,PALTI.TI016", conn);
                ...
                if (main_table.Rows.Count != 0)
                {
                    ...
                    lblAttendanceDay.Text = Convert.ToDouble(main_table.Rows[0][21]).ToString("N0");
                    ...
                    lblBonusTotal.Text = (bonusTotal + Convert.ToDouble(lblOTSalary.Text) + Convert.ToDouble(lblAttendanceBonus.Text)).ToString("N0");
