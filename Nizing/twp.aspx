<%@ Page Title="" Language="C#" MasterPageFile="~/master/product-detail.master" AutoEventWireup="true" CodeFile="twp.aspx.cs" Inherits="twp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" Runat="Server">
    <title>TWP美規薄肉汽車花線-日進電線</title>
    <meta name="description" content="TWP美規薄肉汽車花線，適用於汽車、機車及各式運送工具之美規薄肉低壓絕緣花線。">	
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/twp-1.jpg" AlternateText="TWP 美規薄肉汽車花線" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/twp-2.jpg" AlternateText="TWP 美規薄肉汽車花線" />
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="largePicArea1" Runat="Server">
        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/product_pic/twp-3.jpg" AlternateText="TWP 美規薄肉汽車花線" />
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>TWP美規薄肉汽車花線，適用於汽車、機車及各式運送工具之美規薄肉低壓絕緣花線。</td>
        </tr>
    </table>
    <div class="subtitle">
        技術資料
