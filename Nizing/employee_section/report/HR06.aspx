<%@ Page Title="" Language="C#" MasterPageFile="~/master/report/MasterPage.master" AutoEventWireup="true" CodeFile="HR06.aspx.cs" Inherits="nizing_intranet_HR06" %>
    ...
    <div class="container">
        ...
        <div id="info" style="margin-top: 10px;">
            <div class="table-responsive">
                <asp:GridView ID="gvAssessmentScore" runat="server" CssClass=" table table-striped-blue" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="核決主管姓名" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:Label ID="lbl6" runat="server" Text='<%#Eval("核決主管姓名") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="核決主管評分數" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:Label ID="lbl7" runat="server" Text='<%#Eval("核決主管評分數") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
