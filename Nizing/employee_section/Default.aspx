...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">    
    <div>
        ...
        <div class="dept-block">
            ...
            <ul>
                <li><asp:ImageButton ID="btnInvCheck" runat="server" ImageUrl="~/employee_section/report/image/button/dept/inventory.png" PostBackUrl="~/employee_section/report/InventorySearch.aspx" /></li>
            </ul>
        </div>
        <div class="dept-block">
    ...
    <div>
        <div class="dept-block">
            ...
            <ul>
                <li><asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/employee_section/report/image/button/dept/SD-1.png" PostBackUrl="~/employee_section/report/NetSale.aspx" /></li>
                <li><asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/employee_section/report/image/button/dept/SD-2.png" PostBackUrl="~/employee_section/report/SaleRecord.aspx" /></li>
    ...
    <div>
        <div class="dept-block">
            ...
            <ul>
                ...
                <li><asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="~/employee_section/report/image/button/dept/HR-3.png" PostBackUrl="~/employee_section/report/EmployeeDayOffReport.aspx" /></li>
                <li><asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/employee_section/report/image/button/dept/HR-4.png" PostBackUrl="~/employee_section/report/WorkDuration.aspx" /></li>
                <li><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/employee_section/report/image/button/dept/HR-5.png" PostBackUrl="~/employee_section/report/HR05.aspx" /></li>
