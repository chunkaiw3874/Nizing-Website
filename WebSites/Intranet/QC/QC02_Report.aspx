<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/MasterPage.master" AutoEventWireup="true" CodeFile="QC02_Report.aspx.cs" Inherits="QC_QC02_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="QC02">
        ...
        <div>
            <asp:Button ID="btnConvert" runat="server" Text="PDF" OnClick="btnConvert_Click" />
        </div>
        <div class="printarea">
            <div style="width:100%;">
    ...
    <%--                        <asp:TemplateField HeaderText="品號">
                            ...
                            <asp:TemplateField HeaderText="簽核確認">
                                <ItemTemplate>
                                    <%--<asp:TextBox ID="txtSignOff" runat="server"></asp:TextBox>--%>
                ...
                <div style="display:inline-block;text-align:right;width:100%;">
                    製表人: <asp:Label ID="lblCreator" runat="server"></asp:Label>
                </div>
            </div>
        </div>
    </div>
