<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/HR360_Child.master" AutoEventWireup="true" CodeFile="PR04.aspx.cs" Inherits="hr360_PR04" %>

<asp:Content ID="Content1" ContentPlaceHolderID="javascript_section" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="page_title" Runat="Server">
    <div id="page-title">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/hr360/image/icon/left_menu/PR04-1.png" />
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="top_menu" Runat="Server">
    <div id="top-menu">
        ...
        <div class ="third">
            ...
            <asp:ImageButton ID="toplink_refresh" runat="server" ImageUrl="~/hr360/image/icon/top_menu/refresh-1.png" PostBackUrl="PR04.aspx" OnClick="toplink_refresh_Click" onmouseover="this.src='image/icon/top_menu/refresh-2.png'" onmouseout="this.src='image/icon/top_menu/refresh-1.png'" />
                        ...
                        <ContentTemplate>
                            ...
                            <div class="content">
                                <table class="content-table">
                                    ...
                                    <tr>
                                        <td>考績項目名稱</td>
                                        <td><asp:TextBox ID="txtName" runat="server" MaxLength="50" placeholder="最大字元數量50"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>考績項目備註</td>
                                        <td><asp:TextBox ID="txtMemo" runat="server" MaxLength="255" Width="400" placeholder="最大字元數量255"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </div>
                        </ContentTemplate>
	            ...
	            <div class="popup">
		            ...
		            <div class="content">
        			    <div class="search-condition">
					        ...
					        WHEN N'ID' THEN N'考績項目代號'
					        WHEN N'NAME' THEN N'考績項目名稱'
                            WHEN N'MEMO' THEN N'考績項目備註'
					        END AS COLUMN_NAME_CN
                            FROM INFORMATION_SCHEMA.COLUMNS
                            WHERE TABLE_NAME = N'HR360_PR04_A' AND (COLUMN_NAME=N'CREATEDATE' OR COLUMN_NAME=N'CREATOR' OR COLUMN_NAME=N'MODIFIEDDATE' OR COLUMN_NAME=N'MODIFIER' OR COLUMN_NAME=N'ID' OR COLUMN_NAME=N'NAME' OR COLUMN_NAME=N'MEMO')"></asp:SqlDataSource>
