<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/HR360_Child.master" AutoEventWireup="true" CodeFile="PR10.aspx.cs" Inherits="hr360_PR10" %>

<asp:Content ID="Content1" ContentPlaceHolderID="javascript_section" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="page_title" Runat="Server">
    <div id="page-title">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/hr360/image/icon/left_menu/PR10-1.png" />
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="top_menu" Runat="Server">
    <div id="top-menu">
        ...
        <div class ="third">
            ...
            <asp:ImageButton ID="toplink_refresh" runat="server" ImageUrl="~/hr360/image/icon/top_menu/refresh-1.png" PostBackUrl="PR10.aspx" OnClick="toplink_refresh_Click" onmouseover="this.src='image/icon/top_menu/refresh-2.png'" onmouseout="this.src='image/icon/top_menu/refresh-1.png'" />
                            ...
                            <div class="content">
                                <table class="content-table">
                                    ...
                                    <tr>
                                        <td>評核單號</td>
                                        <td>
                                            <asp:TextBox ID="txtForm_Id" runat="server" AutoPostBack="true" OnTextChanged="txtForm_Id_TextChanged"></asp:TextBox>
                                            <asp:Button ID="btnForm_Id_Select" runat="server" Text="..." PostBackUrl="#search_window_form_id" OnClick="btnForm_Id_Select_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>員工代號</td>
                                    ...
                                    <tr>
                                        <td>評語者名稱</td>
                                        <td>
                                            <asp:Label ID="lblAssessor_Id" runat="server"></asp:Label>
                                            <span style="margin-left:5px"><asp:Label ID="lblAssessor_Name" runat="server"></asp:Label></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>評語</td>
                                        <td>
                                            <asp:TextBox ID="txtAssessor_Comment" runat="server" TextMode="MultiLine" Width="700" Height="200"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:CheckBox ID="chkDisplay" runat="server" Checked="true" Text="是否顯示於考績表" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
...
<%--                                    <Columns>
                                        <asp:TemplateField HeaderText="評核單別">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblFormTypeId" runat="server" Text='<%#Eval("FORM_TYPE_ID") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="評核單別名稱">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblFormTypeName" runat="server" Text='<%#Eval("FORM_TYPE_NAME") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="評核單號">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblFormId" runat="server" Text='<%#Eval("FORM_ID") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="員工代號">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblEmployeeId" runat="server" Text='<%#Eval("EMPLOYEE_ID") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="員工姓名">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblEmployeeName" runat="server" Text='<%#Eval("EMPLOYEE_NAME") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="評核員代號">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblAssessorId" runat="server" Text='<%#Eval("ASSESSOR_ID") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="評核員姓名">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblAssessorName" runat="server" Text='<%#Eval("ASSESSOR_NAME") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="評語">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblAssessorComment" runat="server" Text='<%#Eval("ASSESSOR_COMMENT") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="建立日期">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblCreateDate" runat="server" Text='<%#Eval("CREATEDATE") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="建立者">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblCreator" runat="server" Text='<%#Eval("CREATOR") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="修改日期">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblModifiedDate" runat="server" Text='<%#Eval("MODIFIEDDATE") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="修改者">
                                            <ItemTemplate>
                                                <asp:Label ID="grdResult_lblModifier" runat="server" Text='<%#Eval("MODIFIER") %>' ></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>--%>
	            ...
	            <div class="popup">
		            ...
		            <div class="content">
        			    <div class="search-condition">
                            ...
                            WHERE TABLE_NAME = N'HR360_PR10_A' AND (COLUMN_NAME=N'CREATEDATE' OR COLUMN_NAME=N'CREATOR' OR COLUMN_NAME=N'MODIFIEDDATE' OR COLUMN_NAME=N'MODIFIER' OR COLUMN_NAME=N'FORM_TYPE_ID' OR COLUMN_NAME=N'FORM_ID')"></asp:SqlDataSource>
    ...
    <div id="search_window_form_id" class="overlay">
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>            
	            <div class="popup">
		            ...
		            <div class="content">
                        <div class="search-result">
                            <asp:GridView ID="grdForm" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both" OnSelectedIndexChanged="grdForm_SelectedIndexChanged" CssClass="grdResult">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>                                        
                                <EditRowStyle BackColor="#999999"></EditRowStyle>
                                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White"></FooterStyle>
                                <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White"></HeaderStyle>
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="grdForm" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
</asp:Content>
