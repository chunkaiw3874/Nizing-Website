<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/HR360_Child.master" AutoEventWireup="true" CodeFile="BI03.aspx.cs" Inherits="hr360_BI03" %>
                            ...
                            <div class="content">
                                <table class="content-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlCategory_Name" runat="server" DataSourceID="HR360_MODULE_CATEGORY" DataTextField="NAME" DataValueField="ID"></asp:DropDownList><asp:SqlDataSource runat="server" ID="HR360_MODULE_CATEGORY" ConnectionString='<%$ ConnectionStrings:HR360ConnectionString %>' SelectCommand="SELECT [ID], [NAME] FROM [HR360_BI03_A] ORDER BY [SEQ_NO]"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                                </table>
                            </div>
