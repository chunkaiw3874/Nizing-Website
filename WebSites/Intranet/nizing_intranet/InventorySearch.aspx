<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/masterPage/MasterPage.Master" CodeFile="InventorySearch.aspx.cs" Inherits="InventorySearch" %>
    ...
    <div id="inventory">
        ...
        <div id="search-result">
            <asp:GridView ID="grdResult" runat="server" AutoGenerateColumns="false" CssClass="grdResult">
                <Columns>
                    <asp:TemplateField HeaderText="品號" ItemStyle-Width="100">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="會計分類">
                        <ItemStyle Width="100" />
                        <ItemTemplate>
