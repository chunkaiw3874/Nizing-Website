...
<asp:Content ID="Content1" ContentPlaceHolderID="DocTitleKeywords" Runat="Server">
    <title>UL SRG 玻璃纖維套管-日進電線</title>
    <meta name="description" content="UL SRG 玻璃纖維套管，適用於各種電子電器,照明燈具,工業機器,電熱製品等高溫場所的絕緣保護。詳細的UL SRG 玻璃纖維套管的產品規格以及使用範圍值">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="JavaScriptCode" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="smallPicArea" Runat="Server">
    <div class="content-row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/product_pic/ulsrg-1.jpg" AlternateText="UL SRG 玻璃纖維套管" />
        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/product_pic/ulsrg-2.jpg" AlternateText="UL SRG 玻璃纖維套管" />
    </div>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="briefDescription" Runat="Server">
    ...
    <table>
        <tr>
            <td>UL SRG 玻璃纖維套管適用於各種電子電器,照明燈具,工業機器,電熱製品等高溫場所的絕緣保護</td>
        </tr>
    </table>
    <div class="subtitle">
        技術資料
