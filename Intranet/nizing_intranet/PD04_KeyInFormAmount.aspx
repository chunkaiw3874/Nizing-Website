                        ...
                        <asp:GridView ID="gvResult" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblPurchaseForm" runat="server" Text='<%#Eval("採購單") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblPurchaseFormTotal" runat="server" Text="Label"></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblReceiveMaterialForm" runat="server" Text='<%#Eval("進貨單") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblReceiveMaterialFormTotal" runat="server" Text="Label"></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
