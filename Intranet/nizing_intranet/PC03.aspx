    ...
    <div>
        ...
        <div>
            ...
            <div>
                <div>
                    選擇查詢規格
                    <asp:DropDownList ID="ddlCategory1" runat="server" OnSelectedIndexChanged="ddlCategory1_SelectedIndexChanged" AutoPostBack="true" Width="6em">
                        <asp:ListItem Value="R">RS-GE</asp:ListItem>
                        <asp:ListItem Value="3122-">3122</asp:ListItem>
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlCategory2" runat="server" Width="6em">
            ...
            <br />
            <asp:Button ID="btnReport" runat="server" Text="產生報表" OnClick="btnReport_Click" CssClass="btn" />
        ...
        <div>
            <div class="col-xs-11">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th style="padding-right:20px; padding-top:5px; padding-bottom:5px; border-bottom:solid 1px #cccccc; border-right:solid 1px #cccccc;">
                                押出半成品品號
                            </th>
                            <th style="padding-right:20px; border-bottom:solid 1px #cccccc; border-right:solid 1px #cccccc;">
                                押出半成品數量
                            </th>
                            <th style="padding-right:20px; border-bottom:solid 1px #cccccc; border-right:solid 1px #cccccc;">
                                編織半成品品號
        ...
        <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False" ShowFooter="true" CssClass="grdResultWithFooter">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="客戶簡稱" HeaderStyle-Width="2em">
                    <ItemTemplate>
