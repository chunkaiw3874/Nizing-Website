...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        <h2>採購交期達成率報告</h2>
        <asp:Label ID="Label1" runat="server" Text="請選擇預交日期查詢範圍"></asp:Label>
        <br />
...
<%--            <asp:ListItem Value="2014">2014</asp:ListItem>
       ...
       <asp:DropDownList ID="ddlEndMonth" runat="server">
        ...
        <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="grdResult">
            <Columns>
                <asp:BoundField DataField="採購單號" HeaderText="採購單號" ReadOnly="True" SortExpression="採購單號" >
                </asp:BoundField>
                <asp:BoundField DataField="廠商代號" HeaderText="廠商代號" SortExpression="廠商代號" >
                </asp:BoundField>
                <asp:BoundField DataField="廠商簡稱" HeaderText="廠商簡稱" SortExpression="廠商簡稱" >
                </asp:BoundField>
                <asp:BoundField DataField="採購日期" HeaderText="採購日期" SortExpression="採購日期" >
                </asp:BoundField>
                <asp:BoundField DataField="預交日" HeaderText="預交日" SortExpression="預交日" >
                </asp:BoundField>
                <asp:BoundField DataField="品號" HeaderText="品號" SortExpression="品號" >
                </asp:BoundField>
                <asp:BoundField DataField="品名" HeaderText="品名" SortExpression="品名" >
                </asp:BoundField>
                <asp:BoundField DataField="規格" HeaderText="規格" SortExpression="規格" ReadOnly="True" >
                </asp:BoundField>
                <asp:BoundField DataField="採購數量" HeaderText="採購數量" SortExpression="採購數量" >
                </asp:BoundField>
                <asp:BoundField DataField="已交數量" HeaderText="已交數量" ReadOnly="True" SortExpression="已交數量" >
                </asp:BoundField>
                <asp:BoundField DataField="未交數量" HeaderText="未交數量" ReadOnly="True" SortExpression="未交數量" >
                </asp:BoundField>
                ...
                <asp:BoundField DataField="進貨日" HeaderText="進貨日" ReadOnly="True" SortExpression="進貨日" >
                </asp:BoundField>
                <asp:BoundField DataField="準時" HeaderText="準時" ReadOnly="True" SortExpression="準時" >
                </asp:BoundField>
