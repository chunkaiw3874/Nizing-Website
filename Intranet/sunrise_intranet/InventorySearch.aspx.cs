...
public partial class InventorySearch : System.Web.UI.Page
{
    ...
    {
        string folderPath = Server.MapPath("~/sunrise_intranet/image/inventory_search/");
    ...
    private void UploadFile(string folderPath, bool isCover)
    {
        try
        {
            ...
            if (afuCover.HasFile)
            {
                ...
                imgCover.ImageUrl = @"data:image/jpg;base64," +
                    Convert.ToBase64String(File.ReadAllBytes(folderPath+uid));
