<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/sunrise-master.master" AutoEventWireup="true" CodeFile="ACC01-Sunrize.aspx.cs" Inherits="nizing_intranet_ACC01_SUNRIZE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="ReportSection">
        <div id="divDetailReport" class="table-responsive" runat="server">
        ...
        <div id="divAnnualReport" runat="server">
            <div class="row">
                <div class="col-sm-5">
