<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/HR360_Child.master" AutoEventWireup="true" CodeFile="BI02.aspx.cs" Inherits="hr360_BI02" %>
            ...
            <div id="Authorization_Setup">
                ...
                <div class ="gridview">
                    ...
                    <asp:SqlDataSource runat="server" ID="HR360_MODULE_PERMISSION" 
                        ConnectionString='<%$ ConnectionStrings:HR360ConnectionString %>' 
                        SelectCommand="
