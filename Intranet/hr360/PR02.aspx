<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage/HR360_Child.master" AutoEventWireup="true" CodeFile="PR02.aspx.cs" Inherits="hr360_PR02" %>

<asp:Content ID="Content1" ContentPlaceHolderID="javascript_section" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="page_title" Runat="Server">
    <div id="page-title">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/hr360/image/icon/left_menu/PR02-1.png" />
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="top_menu" Runat="Server">
    <div id="top-menu">
        ...
        <div class ="third">
            ...
            <asp:ImageButton ID="toplink_refresh" runat="server" ImageUrl="~/hr360/image/icon/top_menu/refresh-1.png" PostBackUrl="PR02.aspx" OnClick="toplink_refresh_Click" onmouseover="this.src='image/icon/top_menu/refresh-2.png'" onmouseout="this.src='image/icon/top_menu/refresh-1.png'" />
                                ...
                                <table class="content-table">
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="ddlType" runat="server">
                                            <asp:ListItem>1: 加項</asp:ListItem>
                                            <asp:ListItem>2: 扣項</asp:ListItem>
                                        </asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>獎懲項目名稱</td>
                                        <td><asp:TextBox ID="txtName" runat="server" Width="200" MaxLength="100" placeholder="最大字元數量100"></asp:TextBox></td>
                                        <td>獎懲項目範圍</td>
                                        <td><asp:DropDownList ID="ddlRange" runat="server">
                                            <asp:ListItem>1: 行政類</asp:ListItem>
                                            <asp:ListItem>2: 生產類</asp:ListItem>
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>獎懲項目說明</td>
                                        <td colspan="3"><asp:TextBox ID="txtDescription" runat="server" Width="400" MaxLength="255" placeholder="最大字元數量255"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>獎懲項目備註</td>
                                        <td colspan="3"><asp:TextBox ID="txtMemo" runat="server" Width="400" MaxLength="255" placeholder="最大字元數量255"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </div>
                        </ContentTemplate>
	            ...
	            <div class="popup">
		            ...
		            <div class="content">
        			    <div class="search-condition">
					        ...
					        WHEN N'ID' THEN N'獎懲項目代號'
					        WHEN N'NAME' THEN N'獎懲項目名稱'
					        WHEN N'TYPE' THEN N'獎懲項目屬性'
					        WHEN N'RANGE' THEN N'獎懲項目範圍'
                            WHEN N'DESCRIPTION' THEN N'獎懲項目說明'
                            WHEN N'MEMO' THEN N'獎懲項目備註'
					        END AS COLUMN_NAME_CN
                            FROM INFORMATION_SCHEMA.COLUMNS
                            WHERE TABLE_NAME = N'HR360_PR02_A' AND (COLUMN_NAME=N'CREATEDATE' OR COLUMN_NAME=N'CREATOR' OR COLUMN_NAME=N'MODIFIEDDATE' OR COLUMN_NAME=N'MODIFIER' OR COLUMN_NAME=N'ID' OR COLUMN_NAME=N'NAME' OR COLUMN_NAME=N'TYPE' OR COLUMN_NAME=N'RANGE' OR COLUMN_NAME=N'DESCRIPTION' OR COLUMN_NAME=N'MEMO')"></asp:SqlDataSource>
